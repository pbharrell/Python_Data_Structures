...
class MaxNode(PriorityNode):
    ...
    def __lt__(self, other: 'MaxNode') -> bool:
        """
        Defines less than operator for node
        Behaves opposite b/c min heap
        :param other: Maxnode to compare self to
        :return: True if self greater than other, false otherwise
        """
    ...
    def __gt__(self, other: 'MaxNode') -> bool:
        """
        Defines greater than operator for node
        Behaves opposite b/c min heap
        :param other: Maxnode to compare self to
        :return: True if self less than other, false otherwise
        """
        if self.priority == other.priority:
            return self.value < other.value
...
class MinNode(PriorityNode):
    ...
    def __lt__(self, other: 'MinNode') -> bool:
        """
        Defines less than operator for node
        Behaves as expected b/c max heap
        :param other: Maxnode to compare self to
        :return: True if self less than other, false otherwise
        """
        if self.priority == other.priority:
    ...
    def __gt__(self, other: 'MinNode') -> bool:
        """
        Defines greater than operator for node
        Behaves as expected b/c ma heap
        :param other: Maxnode to compare self to
        :return: True if self greater than other, false otherwise
        """
        if self.priority == other.priority:
